...
const { runTrackedJob, createJobRecord } = await import("../plugins/opencode/scripts/lib/tracked-jobs.mjs");
const { upsertJob, loadState, jobDataPath } = await import("../plugins/opencode/scripts/lib/state.mjs");
