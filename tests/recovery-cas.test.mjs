...
const { recoverStrandedResults } = await import("../plugins/opencode/scripts/lib/job-control.mjs");
const { upsertJob, loadState, jobDataPath, jobLogPath } = await import("../plugins/opencode/scripts/lib/state.mjs");
