...
const MY_LIB = path.join(HERE, "..", "plugins", "opencode", "scripts", "lib");
const SIBLING = process.env.OPENCODE_COMPANION_SIBLING
  ?? path.join(HERE, "..", "..", "opencode-companion-codex");
const SIB_LIB = path.join(SIBLING, "plugins", "opencode-companion", "scripts", "lib");
