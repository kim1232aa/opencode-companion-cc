...
import { buildTaskPrompt, HEADLESS_HEADER, SAFETY_HEADER } from "../plugins/opencode/scripts/lib/prompts.mjs";
import { dispatchWithRetry, watchAndRejectQuestions } from "../plugins/opencode/scripts/lib/opencode-server.mjs";
