 ...
 * exist here — the call errors, and some models then stall indefinitely,
 * emitting nothing. This header neutralizes that without altering the
 * forwarded task text itself.
 */
