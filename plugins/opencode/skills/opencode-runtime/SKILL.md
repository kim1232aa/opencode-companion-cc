...
- Do not inspect the repo, solve the task yourself, or add independent analysis. Your only Claude-side work is stripping routing flags before the single `task` call.
